...
class network(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Conv2d(1,8,kernel_size=3,padding=1,stride=1,bias=False,padding_mode='zeros')
        self.layer2 = nn.Conv2d(8,16,kernel_size=3,padding=1,stride=1,bias=False,padding_mode='zeros')
        self.layer3 = nn.Conv2d(16,8,kernel_size=3,padding=1,stride=1,bias=False,padding_mode='zeros')
        self.layer4 = nn.Conv2d(8,1,kernel_size=3,padding=1,stride=1,bias=False,padding_mode='zeros')

        self.quadratic_int1 = nn.Conv2d(1,8,kernel_size=3,padding=1,stride=1,bias=True,padding_mode='zeros')
        self.quadratic_int2 = nn.Conv2d(8,1,kernel_size=3,padding=1,stride=1,bias=False,padding_mode='zeros')
