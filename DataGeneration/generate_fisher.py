...
iterations = 60 #number of data to generate

#generate
for i in range(iterations):
    print('i =', i, 'initialised')

    process = subprocess.Popen('python call_fisher.py --iteration %s' % i,
...
for i in range(iterations):
    try:
        filename = 'tmp/fisher%d.pickle' % i
...
#Save
filename = 'data_fisher_verification.pickle'
